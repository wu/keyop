...
func (p *RGBMatrixPlugin) Check() error {
	...
	logger.Warn("RGBMatrixPlugin Check called - this plugin runs continuously and does not support health checks")
